...
def export_report():
    ...
    md_content = "# 📊 Lehman Week Report (G3 Architecture)\n\n"
    ...
    for r in daily_reports:
        try:
            ...
            md_content += f"- Justification: {drivers.get('bias_justification', 'N/A')}\n\n"
    ...
    with open("lehman_week_report_g3.md", "w") as f:
        f.write(md_content)
    
    print("Exported to lehman_week_report_g3.md")
