...
| **Toronto Raptors** | +154 | 39.4% | fanduel |

### Spreads

| Team | Spread | Odds | Bookmaker |
|------|--------|------|-----------|
| **Golden State Warriors** | -4.5 | -101 | lowvig |
| **Toronto Raptors** | +4.5 | -110 | fanduel |
...
**Vig/Juice**: Total implied probability = 102.3% (Overround: 2.3%)
...
- Golden State Warriors -4.5: **-101** (better than standard)
- Toronto Raptors +4.5: **-110** (worse than standard)
